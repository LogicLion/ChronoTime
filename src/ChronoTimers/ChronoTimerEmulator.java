...
public class ChronoTimerEmulator extends JApplet {
	...
	public ChronoTimerEmulator() {
		...
		powerButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!isOn){
					...
					c = Command.commandFromString("OFF");
					isOn = false;
				}
				try {
					c.execute(t);
			...
			public void actionPerformed(ActionEvent e) {
				for(int i = 0; i < channelsToTrigger.size(); i++){
					if(e.getSource() == channelsToTrigger.get(i)){
						c = Command.commandFromString("TRIG " + channelsToTrigger.get(i).getText());
			...
			public void actionPerformed(ActionEvent e) {
				for(int i = 0; i < checkBoxes.size(); i++){
					if(e.getSource() == checkBoxes.get(i)){
						c = Command.commandFromString("TOGGLE " + (i+1));
						try {
							c.execute(t);
						} catch (Exception e1) {
							// TODO Auto-generated catch block
		...
		btnPrinterPower.setBounds(535, 15, 117, 29);
		btnPrinterPower.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				t.printer = printerText;
		...
		eventButton.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				c = Command.commandFromString("EVENT " + eventType);
		...
		numButton.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				c = Command.commandFromString("NUM " + inputFromCalcPad);
				inputFromCalcPad = "";
				textFromButtons.setText(inputFromCalcPad);
				try {
					c.execute(t);
		...
		timeButton.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				c = Command.commandFromString("TIME " + inputFromCalcPad);
				inputFromCalcPad = "";
				textFromButtons.setText(inputFromCalcPad);
				try {
					c.execute(t);
		...
		btnNewButton.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				c = Command.commandFromString("NEWRUN");
				try {
					c.execute(t);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
		...
		btnEndrun.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				c = Command.commandFromString("ENDRUN");
				try {
					c.execute(t);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
